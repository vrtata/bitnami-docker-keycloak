...
keycloak_env_vars=(
    ...
    DB_SCHEMA
    JDBC_PARAMS
    KEYCLOAK_DB_DRIVER_NAME
    KEYCLOAK_DB_DRIVER_MODULE
    KEYCLOAK_DB_XA_DATASOURCE_CLASS
    DB_DRIVER_NAME
    DB_DRIVER_MODULE
    DB_XA_DATASOURCE_CLASS
)
...
export KEYCLOAK_MYSQL_DRIVER_DIR="$KEYCLOAK_BASE_DIR/modules/system/layers/keycloak/com/mysql/main"
...
KEYCLOAK_DB_DRIVER_NAME="${KEYCLOAK_DB_DRIVER_NAME:-"${DB_DRIVER_NAME:-}"}"
export KEYCLOAK_DB_DRIVER_NAME="${KEYCLOAK_DB_DRIVER_NAME:-postgresql}"
KEYCLOAK_DB_DRIVER_MODULE="${KEYCLOAK_DB_DRIVER_MODULE:-"${DB_DRIVER_MODULE:-}"}"
export KEYCLOAK_DB_DRIVER_MODULE="${KEYCLOAK_DB_DRIVER_MODULE:-org.postgresql.jdbc}"
KEYCLOAK_DB_XA_DATASOURCE_CLASS="${KEYCLOAK_DB_XA_DATASOURCE_CLASS:-"${DB_XA_DATASOURCE_CLASS:-}"}"
export KEYCLOAK_DB_XA_DATASOURCE_CLASS="${KEYCLOAK_DB_XA_DATASOURCE_CLASS:-org.postgresql.xa.PGXADataSource}"
